...
# Jan's Continue Integration for Visual Studio Code
...
## How to integrate Continue

<div class="text--center"> 
    <img src={vscode} width={600} alt="vscode" />
</div>

To integrate Continue with Jan and Visual Studio Code, follow the steps below:
