...
This guide will show you how to integrate OpenRouter with Jan, allowing you to utilize remote LLMs accessible through OpenRouter.
...
<div class="text--center"> 
    <img src={openrouter} width={600} alt="openrouter" />
</div>

To integrate OpenRouter with Jan, follow the steps below:
