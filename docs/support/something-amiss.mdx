...
1. Ensure your Mac, Windows, or Ubuntu OS is up to date, as this resolves the issue for many users.
...
7. When [checking app logs](https://jan.ai/troubleshooting/how-to-get-error-logs/), encountering the "Bind address failed at 127.0.0.1:3928" error indicates the Nitro port may already be in use. Use specific commands to verify the port status.
