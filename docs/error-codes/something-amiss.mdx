...
7. ou might use the wrong port when you check the app logs and encounter the `Bind address failed at 127.0.0.1:3928` error. To check the port status, try to run the following commands:
