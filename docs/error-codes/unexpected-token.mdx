...
1. Obtain an OpenAI API key from [OpenAI's developer platform](https://platform.openai.com/) and integrate it into your application. Alternatively, you can download a free local model from Jan Hub to run on your computer.
