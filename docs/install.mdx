...
:::
        ...
        Jan is also available for a more experimental version from Jan's Discord in the [`#nightly-builds`](https://discord.gg/q8szebnxZ7) channel.

        ### Uninstall

:::warning

Considering that Jan is in development mode, there's a chance for you to get stuck in a broken build.
...
:::
        ...
        <Tabs groupId="linux_type">
            ...
            <TabItem value="other" label="Other">
                ...
                To do so, you must make the AppImage file executable and then run it. 
...
:::
        ...
        <Tabs groupId="linux_type">
            ...
            <TabItem value="deb_ub" label="Debian / Ubuntu">
                ...
                To uninstall Jan, if you installed Jan via the `.deb` package, you can uninstall Jan using the following command.
            ...
            <TabItem value="other" label="Other">
                ...
                If you wish to remove all user data associated with Jan after uninstallation, you can delete the user data folders at `~/jan`.
