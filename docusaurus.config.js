            ...
            items: [
              {
                html: `
                  <div class="footer-info">
                    <img src="/img/logo.png" alt="Jan AI Logo" height="30px"/>
                    <p>Jan is the open-source, self-hosted alternative to ChatGPT.</p>
                    <div class="footer-info_icons">
                        <a href="#" class="footer-info_icon">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                          <path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm297.1 84L257.3 234.6 379.4 396H283.8L209 298.1 123.3 396H75.8l111-126.9L69.7 116h98l67.7 89.5L313.6 116h47.5zM323.3 367.6L153.4 142.9H125.1L296.9 367.6h26.3z"/>
                          </svg>
                        </a>
                        <a href="#" class="footer-info_icon">
                          <img alt="discord logo" src="/img/discord.png"/>
                        </a>
                        <a href="#" class="footer-info_icon">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    ...
                    <p class="footer-info_copyright">© ${new Date().getFullYear()} Jan AI Pte Ltd.</p>
                  </div>
                `
              }
            ]
